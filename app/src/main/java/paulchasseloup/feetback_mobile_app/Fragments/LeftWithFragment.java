...
public class LeftWithFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, final ViewGroup container, Bundle savedInstanceState) {
        ...
        this.title.setText(R.string.bipodale_title_left_with);
        this.conditions.setText(R.string.bipodale_conditions);
        this.cadre.setText(R.string.bipodale_cadre);
        this.timing.setText(R.string.bipodale_time);
...
//                    try {
    ...
    public void setTitle(String time){
        switch (time){
            case "30" :
                title.setText(getResources().getString(R.string.bipodale_title_left_with));
                break;
            case "10":
                title.setText(getResources().getString(R.string.unipodale_title_left_with));
                break;
            case "01:30":
